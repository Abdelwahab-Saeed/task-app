            ...
            <tbody style="background-color: #22252E;">
                @forelse($notes as $note)
                    <tr class="hover:bg-opacity-50" style="border-bottom: 1px solid #2A2D36;">
                        <td class="px-6 py-4">
                            <div class="text-sm font-medium text-white">{{ $note->title }}</div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <a href="{{ route('admin.notes.edit', $note) }}" style="background-color: #3FA9A6;" class="p-2 text-primary-400 hover:text-primary-300 hover:bg-primary-400/10 rounded-lg transition-colors" title="Edit">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
