...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-slate-400">Update contact information for {{ $contact->company_name }}</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" id="notes" rows="4"
                              class="mt-2 block w-full rounded-md border-0 py-1.5 px-3 text-white bg-[#1A1D24] shadow-sm ring-1 ring-inset ring-[#2A2D36] focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm">{{ old('notes', $contact->notes) }}</textarea>
