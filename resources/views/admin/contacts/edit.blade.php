...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-black">Edit Contact</h1>
        <p class="mt-1 text-sm text-black opacity-50">Update contact information for {{ $contact->company_name }}</p>
    </div>
        ...
        <div class="bg-white shadow rounded-lg border border-slate-100 p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="company_name" id="company_name" value="{{ old('company_name', $contact->company_name) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="contact_person" id="contact_person" value="{{ old('contact_person', $contact->contact_person) }}"
                           class="mt-2 block w-full rounded-md border-slate-100 py-1.5 px-3 text-black shadow-sm focus:ring-2 focus:ring-inset sm:text-sm" style="background-color: #F8FAFC; border: 1px solid #F1F5F9;">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" id="notes" rows="4"
                              class="mt-2 block w-full rounded-md border-slate-100 py-1.5 px-3 text-black shadow-sm focus:ring-2 focus:ring-inset sm:text-sm" style="background-color: #F8FAFC; border: 1px solid #F1F5F9;">{{ old('notes', $contact->notes) }}</textarea>
