        ...
        <div class="relative overflow-hidden rounded-xl p-6" style="background-color: #22252E; border: 1px solid #2A2D36;">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-white">{{ $activeTasks }}</p>
                    <!-- <p class="mt-1 text-xs text-slate-500">+3 from yesterday</p> -->
                </div>
        ...
        <div class="relative overflow-hidden rounded-xl p-6" style="background-color: #22252E; border: 1px solid #2A2D36;">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-white">{{ $completedTasks }}</p>
                    <!-- <p class="mt-1 text-xs text-slate-500">+{{ $completedTasks }} this week</p> -->
                </div>
                <div class="flex-shrink-0">
        ...
        <div class="relative overflow-hidden rounded-xl p-6" style="background-color: #22252E; border: 1px solid #2A2D36;">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-white">{{ $urgentTasks }}</p>
                    ...
                    <div class="p-6 hover:bg-opacity-50 transition-colors" style="border-bottom: 1px solid #2A2D36;">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-sm font-medium text-white truncate">{{ $meeting->title }}</h3>
